...
from .forms import UserProfileInfoForm, UserForm, BalanceTransferForm, AccoutActivationForm ,WithdrawalFundForm, BitcoinDetailForm,UserFormUpdate
...
from .tables import UserInfoTable ,HistryTable
...
############## -------------points------start-----#################
    ...
    points = downline_team_member(request)*30 
